...
const evenmenu = [[["Breakfast-Time","<li>Brown & White Bread<li>Pineapple Jam<li>Corn flakes (Veg)<li>Tea/Coffee/Milk<li>Boiled Black Chana Sprouts<li>Mixed Paratha<li>Curd<li>Green Chutney & Sauce"],["Lunch-Time","<li>Kashmiri Pulao (Basmati)<li>Phulka<li>Dal Fry<li>Paneer Butter Masala<li>Gulab Jamun<li>Mixed Veg Raita<li>Fryums<li>Mixed Salad<li>Mixed Veg Pickle"],["Night-Time","<li>Plain Rice<li>Chapati(3)<li>Green Moong Dal(3)<li>Bhindi Fry<li>Masala Papad<li>Salad<li>Mango Pickle<li>Seasonal Fruit"]],
                    [["Breakfast-Time","<li>OatMeal (Veg)<li>Green Mong Sprouts<li>Moong Dal Cheela<li>Tomato Chutney"],["Lunch-Time","<li>Plain Rice<li>Phulka<li>Palak Dal<li>Raw Banana Dry<li>Soya chunks Curry<li>Curd<li>Papad<li>Salad<li>Lemon Pickle"],["Night-Time","<li>Plain Rice<li>Phulka<li>Dal Tadka<liMix Veg Phuket(3)<li>Fryums<li>Salad<li>Mix Veg Pickle<li>Banana"]],
                    [["Breakfast-Time","<li>Peanut Sundal<li>Poha +Lemon&Onion<li>Jalebi<li>Tamrind Chutney"],["Lunch-Time","<li>Plain Rice<li>Phulka<li>Dal Makhani<li>Lauki Chana Dal<li>Aloo Baigan Toamato Dry<li>Fryums<li>Lassi<li>Salad<li>Pickle"],["Night-Time","<li>Plain Rice<li>Phulka<li>Mixed Dal<li>Mutter Paneer<li>Papad<li>Salad<li>Pickle<liCarrot Halwa(2)<li>Sabudana Kheer(4)"]],
                    [["Breakfast-Time","<li>White Channa Chaat<li>Maggi Dry"],["Lunch-Time","<li>Peas Pulao<li>Chapati<li>Dal Panchranga<li>Gobhi Mutter Dry<li>Palak Paneer<li>Curd<li>Masala Papad<li>Salad<li>Mango Pickle"],["Night-Time","<li>Plain Rice<li>Aloo Paratha<li>Rajma Masala<li>Green Chutney & Curd<li>Papad<li>Salad<li>Lemon Pickle<li>Musk Melon"]],
                    [["Breakfast-Time","<li>Pav Bhaji<li>Black Chnana Sprout"],["Lunch-Time","<li>Plain Rice<li>Phulka<li>Mixed Dal<li>Bhindi Do Pyaza<li>Carrot Beans Dry<li>Curd<li>Fryums<li>Mixed Salad<li>Mixed Veg Pickle"],["Night-Time","<li>Ghee Rice (Basmati)<li>Phulka<li>Moong Dal<li>Mix Veg Kolhapuri(No Potato)<li>Fryums<li>Salad<li>Mix Veg Pickle<li>Papaya"]],
                    [["Breakfast-Time","<li>Oatmeal (Veg)<li>Boiled Moong Sprouts<li>Kachori(2)Semiya Upma(4)<li>Aloo Sabji(2)Coconut<li>Chutney(4)"],["Lunch-Time","<li>Plain Rice<li>Phulka<li>Moong Dal<li>Mixed Sag+Badi<li>Aloo Muttor Curry<li>Curd<li>Papad<li>Salad<li>Pickle"],["Night-Time","<li>Plain Rice<li>Phulka<li>Dal Fry<li>Raw Banana Karamani<li>Masala Papad<li>Salad<li>Mango Pickle<li>WaterMelon"]],
                    [["Breakfast-Time","<li>Mixed Sprouts<li>Poori<li>Chole"],["Lunch-Time","<li>Moong Dal Khichdi<li>Phulka<li>Aloo Chokha (Musturd Oil)<li>Red Pumpkin black Chana<li>Curd<li>Papad<li>Salad<li>Pickle"],["Night-Time","<li>Jeera Rice<li>Chapati<li>Dal Makhani<li>Tava Mix Veg Dry<li>Papad<li>Salad<li>Lemon Pickle<li>Banana+Bournvita Milk"]]];
...
if(hours>=10 && hours<15){
    ...
    if(day==6) day = -1;
    document.getElementById("card-title").innerText ="It is "+ oddmenu[day+1][0][0];
    document.getElementById("card-text").innerHTML = oddmenu[day+1][0][1];
}
else{
...
selector.onchange = function(){
    if(selector.value==1){
        ...
        if(hours>=10 && hours<15){
            ...
            if(day==6) day = -1;
            document.getElementById("card-title").innerText ="It is "+ evenmenu[day+1][0][0];
            document.getElementById("card-text").innerHTML = evenmenu[day+1][0][1];
        }
        else{
